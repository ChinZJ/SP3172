...
<<<<<<< Updated upstream:Java/Board.java
        ExecutorService executor = Executors.newFixedThreadPool(Runtime.getRuntime().availableProcessors());
=======
        ExecutorService executor = Executors.newFixedThreadPool(Runtime.getRuntime().availableProcessors()); // Use maximum number of processors
        // ExecutorService executor = Executors.newFixedThreadPool(8); // State the number of proccessors available
>>>>>>> Stashed changes:Java/BaseModel/Board.java
...
<<<<<<< Updated upstream:Java/Board.java
=======
        // ExecutorService executorTwo = Executors.newFixedThreadPool(8);
>>>>>>> Stashed changes:Java/BaseModel/Board.java
